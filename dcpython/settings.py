...
SECRET_KEY = os.environ.get('SECRET_KEY', '_5p4**ykqgj)pdg=$rh_5)uz%sda+d*spbu3as__8b8^%gp5u%')
...
DATABASES = {'default': dj_database_url.config(default=os.environ.get(
    ...
    'postgres://%s:@localhost:5432/dcpython' % os.environ.get('USER', '')))}
